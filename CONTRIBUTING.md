...
We use **structured GitHub forms** so reports include version info, reproduction steps, and the right context.

### Which repository?

| Topic | Open an issue in |
| ----- | ---------------- |
| Plugin bugs, effects, UI, screen mirror, game telemetry | **[OpenRGB3DSpatialPlugin](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues)** (this repo) |
| Controller layout JSON files | **[OpenRGB3DSpatialPresets](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPresets/issues)** — format: [docs/controller-preset-format.md](docs/controller-preset-format.md), template: [presets/template.controller.json](presets/template.controller.json) |

### Templates on this repo (plugin)

| Template | Use for |
| -------- | ------- |
| [Bug report](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues/new?template=bug_report.yml) | Crashes, wrong behavior, regressions |
| [Feature / suggestion](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues/new?template=feature_request.yml) | New capabilities and UX improvements |
| [Game integration](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues/new?template=game_integration.yml) | Any game: new support, lighting ideas, or fixes (not generic bugs) |
| [Pull request](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/compare) | Code changes (checklist in the PR template) |

### Templates on the presets repo

| Template | Use for |
| -------- | ------- |
| [Preset request](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPresets/issues/new?template=new-controller-preset.yml) | New controller layout, no JSON yet |
| [Preset fix](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPresets/issues/new?template=preset-correction.yml) | Wrong mapping in an existing `.json` |

**Blank issues are disabled** for regular contributors. If you are a **repository maintainer**, GitHub may still offer **Blank issue** — do not use it; pick **Bug report**, **Feature / suggestion**, or **Game integration** from the template list (or the `* (markdown)` fallbacks).

Direct links: [bug](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues/new?template=bug_report.yml) · [feature](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues/new?template=feature_request.yml) · [game](https://github.com/Wolfieeewolf/OpenRGB3DSpatialPlugin/issues/new?template=game_integration.yml)

Reports that skip the form or omit required fields may be **closed** with a request to resubmit using the correct template.
