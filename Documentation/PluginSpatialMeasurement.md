...
[`SpatialMeasurement.md`](SpatialMeasurement.md) describes **PlayerLocal**, **GameWorld**, Room Ambilight SHM (sparse cubemap), and Minecraft block scale — layers **outside** the plugin core. Those bridges must:
...
- Keep the SHM colour path as **sparse LED cubemap texels** (no dense volume grid, no LZ4 dual loader)
