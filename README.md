...
- **Gaming integration** — **Minecraft** uses **Room Ambilight** (room-sample shared memory for viewport colours on the physical LED room) plus UDP telemetry for vitals and damage. Fabric companion mod: [`integrations/minecraft/`](integrations/minecraft/). Treat it as functional best-effort; report issues you hit.
