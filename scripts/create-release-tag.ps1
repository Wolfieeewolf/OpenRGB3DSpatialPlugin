# PowerShell script to create a release tag in the format YY.MM.DD.V
...
Write-Host "Format: YY.MM.DD.V (e.g. v26.02.03.1), date = Australian (AUS Eastern)" -ForegroundColor Cyan
