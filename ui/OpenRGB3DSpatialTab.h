...
class OpenRGB3DSpatialTab : public QWidget
{
    ...
    friend class EventBindingsPanel;
...
private slots:
    ...
    void TryAttachMissingLayoutControllers();
...
private:
    ...
    bool AppendLayoutControllerEntry(const nlohmann::json& controller_json,
    ...
    bool LayoutControllerEntryIsInScene(const nlohmann::json& controller_json) const;
...
private:
    ...
    nlohmann::json cached_profile_layout_;
